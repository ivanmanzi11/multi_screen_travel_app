  ...
  style: TextStyle(
    ...
    color: Color(0xFF1B5E20),
      ...
      ConstrainedBox(
        ...
        child: const Text(
          "We are a Rwanda-focused travel planning service dedicated to helping visitors experience the country with ease and confidence. From wildlife adventures and cultural experiences to transportation and accommodation planning, we support travelers in designing trips that match their interests and schedules.\n\nOur goal is to make exploring Rwanda simple and enjoyable. By combining local knowledge, trusted partners, and personalized support, we help visitors discover Rwanda’s landscapes, wildlife, and vibrant communities without the stress of planning every detail alone.",
          textAlign: TextAlign.center,
          style: TextStyle(
      ...
      ClipRRect(
        ...
        child: Image.asset(
          "assets/images/rwanda.jpg", // ✅ uses your existing hero image
          height: 280,
          width: double.infinity,
          fit: BoxFit.cover,
        ),
