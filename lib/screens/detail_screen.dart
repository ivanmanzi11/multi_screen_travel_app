...
_sectionTitle("Pros & Cons"),
  ...
  String _bestTimeText(String id) {
    if (id == '3') {
      return "Akagera can be visited year-round, but the best wildlife viewing is during the Dry Season (June–September) when animals gather near lakes and water points. A short drier period around mid-December to mid-February can also be great for game drives.";
    }
    if (id == '1') {
      return "Gorilla tracking is possible all year. Dry seasons (June–September and mid-December–February) usually make hiking easier, but rain season can be greener and less crowded.";
    }
    if (id == '2') {
      return "Mount Karisimbi is best climbed in drier months for safer trails and clearer views. Early mornings are colder, so warm layers help a lot.";
    }
    return "Nyungwe is beautiful year-round. Dry seasons are easier for hiking and canopy walks, while rainy months can be misty and very scenic.";
  }
